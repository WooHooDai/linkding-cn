...
When bookmarking a URL that points directly to a PDF file, linkding will download the PDF instead of creating an HTML snapshot. The downloaded PDF is stored as a bookmark asset just like other snapshots.
